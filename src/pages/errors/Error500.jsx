...
export default function Error500() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      <p className="text-[120px] font-bold leading-none tracking-tight text-foreground">500</p>
      <h1 className="text-xl font-semibold mt-2">Oops! Something went wrong :')</h1>
