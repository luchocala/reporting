...
const data = [
  ...
  { month: "SEP", value: 590000 },
  { month: "OCT", value: 520000 },
  { month: "NOV", value: 430000 },
  { month: "DEC", value: 490000 },
];
...
export default function D8SalesRevenueChart() {
      ...
      <CardHeader className="pb-2">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-3xl font-bold tracking-tight mt-0.5" style={{ fontFamily: "monospace" }}>$640,000</p>
