...
export default function D3RevenueChart() {
  return (
        ...
        <div className="h-52">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
              <defs>
                <linearGradient id="d3this" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="hsl(var(--foreground))" stopOpacity={0.15} />
                  <stop offset="95%" stopColor="hsl(var(--foreground))" stopOpacity={0} />
                </linearGradient>
                <linearGradient id="d3prev" x1="0" y1="0" x2="0" y2="1">
              ...
              <Area type="monotone" dataKey="prevYear" stroke="hsl(var(--muted-foreground))" strokeWidth={1.5} fill="url(#d3prev)" dot={false} name="Prev Year" />
              <Area type="monotone" dataKey="thisYear" stroke="hsl(var(--foreground))" strokeWidth={2} fill="url(#d3this)" dot={false} name="This Year" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
